...
THREAT_FEED_TITLE = ""
CBTHREATHUNTER_GET_CB_FEED_ERROR = 'Error occurred while getting the Feed ID: {error}. Please correct the asset, proxy configurations or delete the file: {file} and try again.'
